...
const AddExpanse = ({navigation}) => {
  const url = `https://budgetapp.digitalcube.rs/api/transactions/categories?category_type=outcome`;
      ...
      <ScrollView>
        <View style={{marginRight: 25, marginLeft: 25}}>
          ...
          <View style={{marginTop: 50}}>
            <Text
              style={{fontSize: 16, lineHeight: 19, fontFamily: 'Lato-Bold'}}>
              Choose Category
            </Text>
            ...
            {isPending ? (
              <TouchableOpacity style={styles.button}>
                <Text style={styles.buttonText}>Add an Expanse</Text>
              </TouchableOpacity>
            ) : (
              <TouchableOpacity style={styles.button}>
